...
| # | Thema | Status | Aktion |
|---|---|---|---|
| 1 | ~~SRI-Hash bei ab.js-Update~~ | ✅ Erledigt (25.08.2026) | SRI aus dem Snippet entfernt — Begründung in `README.md` §Security. Altinstallationen mit `integrity` meldet `/api/snippet-check` als `outdated`. |
