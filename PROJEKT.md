...
| **Stand** | 17.07.2026 — � **Responsive Landing + Dashboard-Redesign** — Landingpage responsive: Hero Animation-First auf Mobile, zentrierter Text, Break-Words in Pricing. 📱 **Vercel-Style Sidebar** — Neue Sidebar-Komponente (220px, Dark-only) mit Collapse-Support, Dashboard-Shell mit Card-basiertem Layout. 🎨 **Figma-Onboarding-UI** — Temp-Session-Backend (Migration 012), AI-Workflow-Animation responsive überarbeitet, Figma-Plugin UI ausgebaut. 🔒 **Auth-Fix** — Supabase Captcha/Email-Error-Handling bei leeren Error-Objekten. 🧪 **Mobile E2E-Tests + Unit-Tests** — mobile.spec.ts (147 Zeilen), lib-unit.mjs (202 Zeilen). 🤖 **Claim-Tests-API** — `POST /api/claim-tests` für Temp-Session-User. 🤖 **Robots-Konfiguration** — Dynamische robots.ts. 🖼️ **Screenshots** — Desktop + Live-Screenshots für Social/OG. |
