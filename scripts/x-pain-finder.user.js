...
(function () {
  ...
  function createSidebar() {
    ...
    // Click auf hervorgehobene Posts → Template anzeigen
    document.addEventListener("click", (e) => {
      ...
      const labelKey = pain.label.replace(/^[🔥🟠🟡]\s*/, "");
  ...
  function updateStats() {
    ...
    if (statsDiv) {
      statsDiv.textContent = `${painCount} Pain-Posts gefunden · ${total} gescannt`;
    }
  }
