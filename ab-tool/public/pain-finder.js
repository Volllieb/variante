// variante - X Pain Post Finder v1.2 (Bookmarklet)
// wird via Bookmarklet auf x.com/search* geladen
(function () {
  "use strict";

  // Guard: nicht doppelt injizieren
  if (document.getElementById("variante-sidebar")) return;
