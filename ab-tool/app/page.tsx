...
const tiers = [
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      { label: 'White-label (resell as your own) ', badge: <Badge variant="amber">Coming soon</Badge> },
      { label: 'Multi-site support ', badge: <Badge variant="amber">Coming soon</Badge> },
      { label: 'Team seats ', badge: <Badge variant="amber">Coming soon</Badge> },
    ],
    cta: { label: 'Get notified', href: '/signup', variant: 'outline' as const },
    recommended: false,
  },
]
