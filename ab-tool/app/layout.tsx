  ...
  return (
    <html lang="en" className={`${inter.variable}`} style={{ '--font-display': inter.style.fontFamily } as React.CSSProperties} suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-bg-0 text-[#ededed]/80 antialiased" suppressHydrationWarning>
        {/* Skip-Link: WCAG 2.4.1 Level A — erstes fokussierbares Element,
            sichtbar nur bei Tastatur-Fokus. Ziel: id="main" in jedem Layout. */}
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:absolute focus:left-2 focus:top-2 focus:z-[100] focus:rounded-[var(--radius-md)] focus:bg-fill-invert focus:px-4 focus:py-2 focus:text-text-on-invert focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text/30"
        >
          Skip to content
        </a>
