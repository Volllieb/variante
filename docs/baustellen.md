...
| 11 | Health Check → Snippet Check Umbau | 🟡 Geplant | Health Check ist over-engineered (3 Steps: Login, Website, Figma). Figma ist Zukunftsprojekt. Neues Konzept: Snippet-Status-Badge direkt im Dashboard, Domain-Eingabe inline, keine separate Health-Seite mehr nötig. Doku: `docs/redesign-snippet-check.md`. |
